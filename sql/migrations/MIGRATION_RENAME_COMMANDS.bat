@echo off
REM ============================================================================
REM Migration File Renumbering Script (Windows)
REM ============================================================================
REM Purpose: Rename migration files to resolve duplicate numbering
REM Date: 2026-01-11
REM
REM IMPORTANT: Review MIGRATION_RENUMBERING_PROPOSAL.md before executing
REM
REM Usage:
REM   1. Backup your sql/migrations directory first!
REM   2. Review this script carefully
REM   3. Run: MIGRATION_RENAME_COMMANDS.bat
REM ============================================================================
...
REM ============================================================================
REM Phase 1: Infrastructure & Core (002-005)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 2: Purchase Invoice Lifecycle (006-007)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 3: HSN/Tax Management (008-015)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 4: Pricing Engine (016-018)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 5: Sales Intent System (019-022)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 6: Multi-Store Architecture (023)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 7: Payroll System (024-029)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 8: Critical Bug Fixes (033-034)
REM ============================================================================
echo.
...
REM ============================================================================
REM Phase 9: Test Data & Utilities (090-092)
REM ============================================================================
echo.
...
REM ============================================================================
REM Move Test Data to Separate Directory
REM ============================================================================
echo.
...
echo   2. Verify no files are missing with: dir /b *.sql
